...
function twentytwenty_register_styles()
{
    ...
    wp_register_style('style', get_template_directory_uri() . '/style.css', false, '20150320');
    wp_register_style('menustyle', get_template_directory_uri() . '/assets/css/menustyle.css', false, '20150320');
...
function wpb_custom_new_menu()
{
    register_nav_menus(
        array(
            ...
            'extra-menu-mobile' => __('Mobile Menu'),
        )
    );
}
...
function twentytwenty_setup()
{
    ...
    add_image_size("specialities", 500, 300, true);
}
...
function twentytwenty_block_editor_styles()
{
    ...
    wp_enqueue_style('twentytwenty-block-editor-styles', get_theme_file_uri('/assets/css/editor-style-block.css'), array(), wp_get_theme()->get('Version'), mt_rand(1, 9));
